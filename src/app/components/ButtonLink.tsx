    ...
    <PrismicNextLink field={field} {...props}>
      <span
        className={clsx(
          ...
          color === "Primary" &&
            "bg-brand-green text-white rounded-full border border-solid text-sm",
          color === "Secondary" &&
            "bg-brand-orange text-white rounded-full border border-solid text-sm",
        ...
        {(color === "Link" || color === "Primary" || color === "Secondary") && (
          <HiArrowRight
            className={clsx(
              ...
              color === "Secondary" &&
                "ml-0.5 -rotate-45 group-hover:rotate-0 group-hover:translate-x-1 animate-pulse"
            )}
            size={16}
          />
        )}
