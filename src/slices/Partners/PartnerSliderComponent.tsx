    ...
    <div>
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex gap-2">
          <button
            className="swiper-button-prev-custom w-8 h-8 bg-black text-white flex items-center justify-center hover:bg-brand-yellow hover:text-black transition-colors duration-200 cursor-pointer group"
            aria-label="Previous slide"
          >
            <span className="relative block w-4 h-4 overflow-hidden">
              <svg
                className="w-4 h-4 block transition-all duration-300 group-hover:-translate-y-full fill-white group-hover:fill-black"
                viewBox="0 0 24 24"
              >
                <path d="M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z" />
              </svg>
              <svg
                className="w-4 h-4 absolute top-0 left-0 translate-y-full block transition-all duration-300 group-hover:translate-y-0 fill-black"
                viewBox="0 0 24 24"
              >
                <path d="M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z" />
              </svg>
          ...
          <button
            className="swiper-button-next-custom w-8 h-8 bg-black text-white flex items-center justify-center hover:bg-brand-yellow hover:text-black transition-colors duration-200 cursor-pointer group"
